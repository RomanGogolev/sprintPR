...
<div class="container">
    ...
    <div class="jumbotron">
        <h3 style="color: #080808">Тема:${support.theme}</h3>
        <p style="color: #080808">Ваше сообщение:${support.messageuser}</p>
        <p class="${support.messageadmin}" style="color: #080808">${support.messageadmin}</p>
    </div>
</div>
</body>
<style>
